...
[_daedalus.data_](https://github.com/jameel-institute/daedalus.data) is a stand-alone helper R pakage to handle input data for the _daedalus_ model. Its purpose is to allow users to flexibly manipulate or change epidemiological and economic data, without needing to modify the model itself.
