...
daedalus_ode <- structure(
  ...
  parameters = data.frame(
    name = c("beta", "sigma", "p_sigma", "epsilon", "rho", "eta", "hfr", "gamma_Ia", "gamma_Is", "gamma_H_recovery", "gamma_H_death", "nu", "susc", "psi", "n_age_groups", "n_econ_groups", "popsize", "cm", "cm_work", "cm_cons_work", "hospital_capacity", "response_time", "response_duration", "auto_social_distancing"),
