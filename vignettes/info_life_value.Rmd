...
**Note also that** preparatory calculations of the value of a statistical life are performed in the data preparation scripts in our companion data package [_daedalus.data_](https://github.com/jameel-institute/daedalus.data/).
:::
