...
output <- daedalus("Canada", "sars_cov_2_pre_alpha")
```
...
Users can also override epidemic-specific infection parameter values as well as change the initial conditions by passing arguments to `daedalus()` in one of three lists: `country_params_manual`, `infect_params_manual`, and `initial_state_manual`, which override the country contact data, the infection parameters, and the initial state defaults respectively.
...
daedalus("Canada", "influenza_1918", infect_params_manual = list(r0 = 1.3))
