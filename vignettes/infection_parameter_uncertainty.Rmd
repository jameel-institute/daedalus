...
We draw a set of 100 $R_0$ values from a normal distribution to parameterise 100 `<daedalus_infection>` objects, which can be passed as a list to [daedalus()].
