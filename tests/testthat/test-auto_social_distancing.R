test_that("daedalus: Auto-social distancing works", {
  expect_no_condition(
    daedalus(
      "GBR", "sars_cov_1",
      "elimination", auto_social_distancing = "off",
      time_end = 100
    )
  )
  expect_no_condition(
    daedalus(
      "GBR", "sars_cov_1",
      "elimination", auto_social_distancing = "independent",
      time_end = 100
    )
  )
  expect_no_condition(
    daedalus(
      "GBR", "sars_cov_1",
      "elimination", auto_social_distancing = "npi_linked",
      time_end = 100
    )
  )
  ...
  data_sd_off = daedalus(
      "GBR", "sars_cov_1",
      "none", auto_social_distancing = "off",
      time_end = 100
    )
  data_sd_ind = daedalus(
    "GBR", "sars_cov_1",
    "none", auto_social_distancing = "independent",
    time_end = 100
  )
  data_sd_npi = daedalus(
    "GBR", "sars_cov_1",
    "none", auto_social_distancing = "npi_linked",
    time_end = 100
  )
  ...
  expect_identical(
    fs_sd_npi$value, fs_sd_off$value
  )
  expect_lt(
    fs_sd_ind$value, fs_sd_off$value
  )
